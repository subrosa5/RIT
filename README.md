...
вроде «Смартеки» и форума «Сильные идеи для нового времени» у [АСИ](https://asi.ru/).
**Проект не аффилирован с АСИ** — это самостоятельная демонстрация подхода к
похожей по духу задаче.
...
масштабируются в заявках быстрее, чем в экспертах, которые их читают.
Форум АСИ «Сильные идеи для нового времени» публично описывает воронку
тысячи заявок → топ-1000 → топ-200 → топ-100, отбираемую экспертным сообществом.

## Гипотеза

**Это гипотеза, не подтверждённый факт** — у меня нет данных о том, что
именно этот этап уже автоматизирован внутри АСИ. Но на таком масштабе
предварительный AI-скоринг и обнаружение дублей обычно снимают с экспертов
самую механическую часть работы, оставляя им финальное решение.
